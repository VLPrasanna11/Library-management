...
def DatabaseCreate():
    cnx = mysql.connector.connect(user='root', password='familybro', host='localhost')
    Cursor = cnx.cursor()
...
def TablesCreate():
    cnx = mysql.connector.connect(user='root', password='familybro', host='localhost', database='Library')
    Cursor = cnx.cursor()
